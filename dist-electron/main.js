...
var { app, BrowserWindow, Tray, nativeImage, shell, dialog, ipcMain } = require("electron");
...
function openConfigPageInBrowser() {
	const url = `http://localhost:${refreshConfig().webConfig.port}`;
...
function persistFloatingButtonPosition() {
	...
	currentConfig = normalizeConfig({ floatingButton: {
